...
Begin VB.Form frmSetting 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(1)=   "cmbSelFolderBD"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "cmbSaveBD"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "txtBD"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).ControlCount=   4
      TabCaption(1)   =   "Виїзд пенсіонера"
      TabPicture(1)   =   "frmSetting.frx":0028
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "txtVP(0)"
      Tab(1).Control(1)=   "cmbSelFolder_VP"
      Tab(1).Control(2)=   "txtVP(1)"
      Tab(1).Control(3)=   "txtVP(2)"
      Tab(1).Control(4)=   "txtVP(3)"
      Tab(1).Control(5)=   "txtVP(4)"
      Tab(1).Control(6)=   "cmbSaveVP"
      ...
      Tab(2).Control(0)=   "cmbTEST(0)"
      Tab(2).Control(1)=   "cmbTEST(1)"
      Tab(2).Control(2)=   "txtFtp(0)"
      Tab(2).Control(3)=   "txtFtp(1)"
      Tab(2).Control(4)=   "txtFtp(2)"
      Tab(2).Control(5)=   "txtFtp(3)"
      Tab(2).Control(6)=   "txtFtp(4)"
      Tab(2).Control(7)=   "cmbSaveFtp"
      Tab(2).Control(8)=   "txtFtp(5)"
      Tab(2).Control(9)=   "txtFtp(6)"
      Tab(2).Control(10)=   "txtFtp(7)"
      Tab(2).Control(11)=   "Label9"
      Tab(2).Control(12)=   "Label11"
      Tab(2).Control(13)=   "Label10"
      Tab(2).Control(14)=   "Label12"
      Tab(2).Control(15)=   "Label13(0)"
      Tab(2).Control(16)=   "Label14"
      Tab(2).Control(17)=   "Label13(1)"
      Tab(2).Control(18)=   "Label15"
      Tab(2).ControlCount=   19
      TabCaption(3)   =   "Надіслати звіти"
      TabPicture(3)   =   "frmSetting.frx":0060
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Chk_Oper1"
      Tab(3).Control(1)=   "Chk_Oper2"
      Tab(3).Control(2)=   "Chk_Oper3"
      Tab(3).Control(3)=   "Chk_Oper4"
      Tab(3).Control(4)=   "cmbSaveSR"
      Tab(3).Control(5)=   "cmbSelFolder_SR2"
      Tab(3).Control(6)=   "txtSR(1)"
      Tab(3).Control(7)=   "cmbSelFolder_SR1"
      Tab(3).Control(8)=   "txtSR(0)"
...
WriteINI "viezd", "ln", txtVP(2).Text, PathFileIni
...
txtVP(2).Text = ReadINI("viezd", "ln", PathFileIni)
